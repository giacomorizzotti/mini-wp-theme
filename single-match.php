				...
				<div clasS="container">
					<div class="boxes space-top align-items-end" style="min-height: 75vh;">
						...
						<div class="box-zero-50 <?php if ( get_post_meta($post->ID, 'team_1_score')[0] ):?>box-sm-40<?php else: ?>box-sm-25<?php endif; ?> pb-0">
							<div class="boxes justify-content-between oh border light-grey-border g-0<?php if ( get_post_meta($post->ID, 'team_1_score')[0] ):?> fw-bg<?php else: ?> fw-bg<?php endif; ?>" style="border-top-left-radius: 25px; border-top-right-radius: 25px;">
						...
						<div class="box-zero-50 <?php if ( get_post_meta($post->ID, 'team_2_score')[0] ):?>box-sm-40<?php else: ?>box-sm-25<?php endif; ?> pb-0">
							<div class="boxes justify-content-between oh border light-grey-border g-0<?php if ( get_post_meta($post->ID, 'team_2_score')[0] ):?> fw-bg<?php else: ?> fw-bg<?php endif; ?>" style="border-top-left-radius: 25px; border-top-right-radius: 25px;">
