(function (blocks, element, blockEditor, components, data, i18n) {
    ...
    blocks.registerBlockType('mini/posts', {
        edit: function (props) {
            ...
            return el(
                ...
                el(
                    ...
                    el(
                        PanelBody,
                        { title: __('Posts settings', 'mini'), initialOpen: true },
                        el(RangeControl, {
                ...
                el('div', blockProps,
                    el('p', {
                        style: { margin: 0, fontWeight: '600', color: '#6a82d4', fontSize: '13px' }
                    }, '📝 ' + __('Posts', 'mini') + ' — ' + attrs.count + ' ' + __('posts', 'mini') + ', ' + Math.round(100 / parseInt(attrs.columns)) + ' ' + __('cols', 'mini'))
                )
            );
        },
